...
export class ApiServerService {
  ...
  getBloodDonationDetailsByDonorId(donorId) {
    return this.http.get<any>(`${this.url}/bloodBankDonorDetails?donorId=${donorId}`)
      .toPromise()
      .then(data => { return data; })
      .catch((err) => {
        console.log(err);
  ...
  getNewBornChildDetailsByChildId(childId) {
    return this.http.get<any>(`${this.url}/newBornChildDetails?childId=${childId}`)
      .toPromise()
      .then(data => { return data; })
      .catch((err) => {
        console.log(err);
