...
import { PatientAdonsEntryDetailsComponent } from './patient-adons-entry-details/patient-adons-entry-details.component';
...
const routes: Routes = [
    ...
    {
        path: 'patient-adons-system',
        component: PatientAdonsEntryDetailsComponent
    },
    {
